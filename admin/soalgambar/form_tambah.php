...
// binds form submission and fields to the validation engine
  ...
  <body>
      ...
      <div class="container">
          ...
          <form action="insert.php" method="post" id="formtambah" name="formtambah" enctype="multipart/form-data">
          <a href="index.php?halaman=1" <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button></a>
              <legend>Input Soal</legend>
            ...
            <div class="controls">
                <input type="file" style="width:300px;" name="pertanyaan" class="span2 validate[required] text-input">
            </div>
            </div>
            <div class="control-group">
