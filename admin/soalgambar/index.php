	...
	<tr>
		...
		<td><?php echo $rows['nama']; ?></td>
                <td>
                    <?php
            if ($rows['pertanyaan'] != '') {
                ?> <img src="<?php echo 'resources/soal/' . $rows['pertanyaan']; ?>"  alt="<?php echo $rows['pertanyaan']; ?>"width="25px" height="20px">
                <?php
            } else {
                echo "No";
            }
		...
		<td align="center">
                    <a href="from_update.php?id_soal=<?php echo $rows['id_soal']; ?>" class="btn btn-warning">
