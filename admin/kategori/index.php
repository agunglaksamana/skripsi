          ...
          <a class="btn btn-navbar" data-toggle="collapse" data-target=".nav-collapse">
	        ...
	        <a href="#" class="dropdown-toggle" data-toggle="dropdown"><i class="icon-folder-open icon-white"></i> Setting<b class="caret"></b></a>
                <ul class="dropdown-menu">
                  ...
                  <li><a href="index.php?halaman=1">Setting Kategori</a></li>
	  ...
	  <div class="navbar-inner">
		<div class="container">
		  ...
		  <div class="nav-collapse">
			<ul class="nav">
                            <li><a href="form_tambah.php" class="small-box"><i class="icon-plus-sign icon-white"></i> Tambah Data Kategori</a></li>
			</ul>
		  </div>
                  <form name="user_form_search" action="" method="post" class="form-search">
			<div class="navbar-form pull-right">	
                      <input type="text" class="span3" name="nama" placeholder="Masukkan Nama Kategori"/>
...
$query="SELECT * FROM kategori ORDER BY nama LIMIT $posisi,$batas";
$query_page="SELECT id_kategori FROM kategori";
if(isset($_POST['nama'])){
$nama=$_POST['nama'];
$query="SELECT * FROM kategori WHERE nama LIKE '%$nama%'";
$query_page="SELECT id_kategori FROM kategori WHERE nama LIKE '%$nama%'";
}
...
while($rows=mysql_fetch_array($result)){
	...
	<tr>
		...
		<td><?php echo $no+$posisi; ?></td>
                ...
                <td align="center">
		<a href="form_update.php?id_kategori=<?php echo $rows['id_kategori']; ?>" class="btn btn-warning">
		<i class="icon icon-pencil"></i> Update</a>
		<a href="delete.php?id_kategori=<?php echo $rows['id_kategori']; ?>" 
